...
# 新しいダウンロードアイコン（Flaticonの「Footage」アイコン、Base64に変換済み）
APP_ICON_B64 = """
...
def get_app_icon():
    pixmap = QPixmap()
    # Base64データから "data:image/png;base64," 接頭辞を削除してデコードする
    ...
    if not pixmap.isNull():
        ...
        # デフォルトのアイコン（失敗時の暫定的な代替）
        pixmap = QPixmap(32, 32)
        pixmap.fill(Qt.GlobalColor.black)  # 仮の四角形
        return QIcon(pixmap)
